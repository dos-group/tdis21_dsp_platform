...
public class DataAlert {
    ...
    public DataAlert(String sensorId, Date timestamp, double value, double lowerThreshold, double upperThreshold) {
    ...
    public Tuple3<String, Date, String> toTuple() {
        String message = "Value " + value + " outside of confidence interval by " + getSeverity();
        return new Tuple3<>(sensorId, timestamp, message);
    }
