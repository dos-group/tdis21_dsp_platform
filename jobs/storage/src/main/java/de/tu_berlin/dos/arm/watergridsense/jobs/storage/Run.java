package de.tu_berlin.dos.arm.watergridsense.jobs.storage;
    ...
    public static void main(String[] args) throws Exception {
        ...
        ClusterBuilder builder = new ClusterBuilder() {
            ...
            protected Cluster buildCluster(Builder builder) {
                ...
                catch (KeyStoreException | NoSuchAlgorithmException | CertificateException | KeyManagementException | IOException kse) {
        ...
        CassandraSink.addSink(tupleEnrichedSensorStream)
            ...
            .setQuery(
                "INSERT INTO " + keySpace + ".measurements(sensorid, timestamp, type, location, unit, rawValue, conValue) " +
